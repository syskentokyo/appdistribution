    ...
    <div class="mt-5 row g-3">
        ...
        <div class="col-12">
            ...
            <div class="input-group">
                <?php echo $distributionInfo->dataid;  ?>
            </div>
        </div>
        ...
        if($iosAppInfo != null){
            ...
            <div class="col-12">
                ...
                <div class="input-group">
                    ...
                    <a href="<?php echo $appDetaiPageURL."?dataid=".$iosAppInfo->dataID . "&platform=".AppFilePlatform::iOS->value;  ?>" target="_blank">Detail App</a>
                </div>
            </div>
        ...
        if($androidAppInfo != null){
            ...
            <div class="col-12">
                ...
                <div class="input-group">
                    <?php echo "#".$androidAppInfo->dataID;  ?>
                </div>
            </div>
            ...
            <div class="col-12">
                ...
                <div class="input-group">
                    ...
                    <a href="<?php echo $appDetaiPageURL."?dataid=".$iosAppInfo->dataID . "&platform=".AppFilePlatform::Android->value;  ?>" target="_blank">Detail App</a>
                </div>
            </div>
